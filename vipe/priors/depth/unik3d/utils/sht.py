...
def rsh_cart_5(xyz: torch.Tensor):
    ...
    return torch.stack(
        [
            ...
            0.241571547304372
            * y
            * (2.25 * z * (2.33333333333333 * z * (1.5 - 7.5 * z2) + 4.0 * z) + 9.375 * z2 - 1.875),
            -1.24747010616985 * z * (1.5 * z2 - 0.5)
            + 1.6840846433293
            * z
            * (1.75 * z * (1.66666666666667 * z * (1.5 * z2 - 0.5) - 0.666666666666667 * z) - 1.125 * z2 + 0.375)
            + 0.498988042467941 * z,
            0.241571547304372
            * x
            * (2.25 * z * (2.33333333333333 * z * (1.5 - 7.5 * z2) + 4.0 * z) + 9.375 * z2 - 1.875),
    ...
    return torch.stack(
        [
            ...
            * (2.25 * z * (2.33333333333333 * z * (1.5 - 7.5 * z2) + 4.0 * z) + 9.375 * z2 - 1.875),
            ...
            2.07566231488104 * z * (-6.0 * x2 * y2 + x4 + y4),
            -0.65638205684017 * x * (-10.0 * x2 * y2 + x4 + 5.0 * y4),
            4.09910463115149 * x**4 * xy - 13.6636821038383 * xy**3 + 4.09910463115149 * xy * y**4,
            -2.36661916223175 * yz * (-10.0 * x2 * y2 + 5.0 * x4 + y4),
            0.00427144889505798 * xy * (x2 - y2) * (5197.5 * z2 - 472.5),
            0.00584892228263444 * y * (3.0 * x2 - y2) * (3.66666666666667 * z * (52.5 - 472.5 * z2) + 280.0 * z),
            0.0701870673916132 * xy * (2.75 * z * (3.0 * z * (52.5 * z2 - 7.5) - 30.0 * z) - 91.875 * z2 + 13.125),
            0.221950995245231
            * y
            * (
                -2.8 * z * (1.5 - 7.5 * z2)
                + 2.2 * z * (2.25 * z * (2.33333333333333 * z * (1.5 - 7.5 * z2) + 4.0 * z) + 9.375 * z2 - 1.875)
                - 4.8 * z
            ),
            -1.48328138624466 * z * (1.66666666666667 * z * (1.5 * z2 - 0.5) - 0.666666666666667 * z)
            + 1.86469659985043
            * z
            * (
            ...
            * (
            ...
            0.0350935336958066
            * (x2 - y2)
            * (2.75 * z * (3.0 * z * (52.5 * z2 - 7.5) - 30.0 * z) - 91.875 * z2 + 13.125),
            0.00584892228263444 * x * (x2 - 3.0 * y2) * (3.66666666666667 * z * (52.5 - 472.5 * z2) + 280.0 * z),
    ...
    return torch.stack(
        [
            ...
            * (2.75 * z * (3.0 * z * (52.5 * z2 - 7.5) - 30.0 * z) - 91.875 * z2 + 13.125),
            ...
            - 10.2477615778787 * x4 * y2
            - 0.683184105191914 * y2**3,
            -0.707162732524596 * y * (7.0 * x2**3 + 21.0 * x2 * y4 - 35.0 * x4 * y2 - y2**3),
            2.6459606618019 * z * (6.0 * x**4 * xy - 20.0 * xy**3 + 6.0 * xy * y**4),
            9.98394571852353e-5 * y * (5197.5 - 67567.5 * z2) * (-10.0 * x2 * y2 + 5.0 * x4 + y4),
            0.00239614697244565 * xy * (x2 - y2) * (4.33333333333333 * z * (5197.5 * z2 - 472.5) - 3150.0 * z),
            0.00397356022507413
            * y
            * (3.0 * x2 - y2)
            * (3.25 * z * (3.66666666666667 * z * (52.5 - 472.5 * z2) + 280.0 * z) + 1063.125 * z2 - 118.125),
            0.0561946276120613
            * xy
            * (
                -4.8 * z * (52.5 * z2 - 7.5)
                + 2.6 * z * (2.75 * z * (3.0 * z * (52.5 * z2 - 7.5) - 30.0 * z) - 91.875 * z2 + 13.125)
                + 48.0 * z
            ),
            0.206472245902897
            * y
            ...
            * z
            * (
                -1.45833333333333 * z * (1.66666666666667 * z * (1.5 * z2 - 0.5) - 0.666666666666667 * z)
                + 1.83333333333333
                * z
                * (
                    -1.33333333333333 * z * (1.5 * z2 - 0.5)
                    ...
                    * z
                    * (
                        1.75 * z * (1.66666666666667 * z * (1.5 * z2 - 0.5) - 0.666666666666667 * z)
                        - 1.125 * z2
                        + 0.375
                    )
                    + 0.533333333333333 * z
            ...
            * (-6.0 * x2 * y2 + x4 + y4),
            9.98394571852353e-5 * x * (5197.5 - 67567.5 * z2) * (-10.0 * x2 * y2 + x4 + 5.0 * y4),
            2.6459606618019 * z * (x2**3 + 15.0 * x2 * y4 - 15.0 * x4 * y2 - y2**3),
            -0.707162732524596 * x * (x2**3 + 35.0 * x2 * y4 - 21.0 * x4 * y2 - 7.0 * y2**3),
        ],
        -1,
    )
    ...
    return torch.stack(
        [
            ...
            * (-6.0 * x2 * y2 + x4 + y4),
            ...
            -2.91570664069932 * yz * (7.0 * x2**3 + 21.0 * x2 * y4 - 35.0 * x4 * y2 - y2**3),
            7.87853281621404e-6 * (1013512.5 * z2 - 67567.5) * (6.0 * x**4 * xy - 20.0 * xy**3 + 6.0 * xy * y**4),
            5.10587282657803e-5
            * y
            ...
            * xy
            * (x2 - y2)
            * (3.75 * z * (4.33333333333333 * z * (5197.5 * z2 - 472.5) - 3150.0 * z) - 14293.125 * z2 + 1299.375),
            0.0028519853513317
            * y
            * (3.0 * x2 - y2)
            * (
            ...
            * (
            ...
            1.48417251362228 * z * (1.66666666666667 * z * (1.5 * z2 - 0.5) - 0.666666666666667 * z)
            - 1.86581687426801
            * z
            * (
                -1.33333333333333 * z * (1.5 * z2 - 0.5)
            ...
            * (-10.0 * x2 * y2 + x4 + 5.0 * y4),
            7.87853281621404e-6 * (1013512.5 * z2 - 67567.5) * (x2**3 + 15.0 * x2 * y4 - 15.0 * x4 * y2 - y2**3),
            -2.91570664069932 * xz * (x2**3 + 35.0 * x2 * y4 - 21.0 * x4 * y2 - 7.0 * y2**3),
...
class SphHarm(torch.nn.Module):
    ...
    def forward(self, points: torch.Tensor) -> torch.Tensor:
        ...
        vals = torch.cat(
            [
                ...
                torch.arange(theta.shape[0], device=theta.device).unsqueeze(0).repeat_interleave(vals.shape[1], dim=1),
            ],
            dim=0,
        )
        ...
        harmonics = torch.where(m < 0, (-1.0) ** m.abs() * torch.conj(harmonics), harmonics)
    ...
    def _gen_recurrence_mask(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        d_zeros = torch.zeros((self.l_max + 1, self.l_max + 1), dtype=self.dtype, device=self.device)
    ...
    def _init_legendre(self):
        ...
        if self.is_normalized:
            ...
            initial_value: torch.Tensor = torch.tensor(0.5 / (torch.pi**0.5), device=self.device)
    ...
    def _gen_associated_legendre(self, x: torch.Tensor) -> torch.Tensor:
        ...
        evalution points.
        """
        p = torch.zeros((self.l_max + 1, self.l_max + 1, x.shape[0]), dtype=x.dtype, device=x.device)
        p[0, 0] = self.initial_value

        # Compute the diagonal entries p(l,l) with recurrence.
        y = torch.cumprod(torch.broadcast_to(torch.sqrt(1.0 - x * x), (self.l_max, x.shape[0])), dim=0)
        p_diag = self.initial_value * torch.einsum("i,ij->ij", self.f_a, y)
        # torch.diag_indices(l_max + 1)
        diag_indices = torch.stack([torch.arange(0, self.l_max + 1, device=x.device)] * 2, dim=0)
        p[(diag_indices[0][1:], diag_indices[1][1:])] = p_diag

        diag_indices = torch.stack([torch.arange(0, self.l_max, device=x.device)] * 2, dim=0)
        ...
        p[(diag_indices[0][: self.l_max], diag_indices[1][: self.l_max] + 1)] = p_offdiag
